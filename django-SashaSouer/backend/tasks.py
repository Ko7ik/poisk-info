...
from backend.models import Task, VkParserData, StatusTask
from backend.serializer import TaskSerializer, VKParserSerializers, StatusSerializers
from backend import rabbitmq_consumer
